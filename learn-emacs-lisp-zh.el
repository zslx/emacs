...
(defun showlist (lst)
  ...
  (mapcar 'lst2str lst)
  (other-window 1))
(showlist auto-mode-alist)
(showlist list-of-names)

(assoc "\\.js\\'" auto-mode-alist)
(assq "\\.js\\'" auto-mode-alist)
(assq-delete-all "\\.js\\'" auto-mode-alist)
(let ((item (assoc "\\.js\\'" auto-mode-alist)))
  (setcdr item 'js2-mode))
